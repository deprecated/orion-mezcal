...
#+BEGIN_SRC python :results output
  import astropy.io.fits as fits
  km = 1.0
  for line in "oiii", "nii", "ha": 
      hdu, = fits.open("/Users/will/Work/BobKPNO/2004/vcube.{}.fits".format(line))
      hdu.header.update(CD1_1=-1.48333333333e-4, CRVAL1=83.8185, CRPIX1=187.0, CTYPE1="RA---TAN",
                        ...
                        CD3_3=4.0*km, CRPIX3=31, CRVAL3=18.0*km, CTYPE3="VOPT", CUNIT3="km/s")
      hdu.writeto("DOH-{}-cube.fits".format(line), clobber=True)
  
#+END_SRC

#+RESULTS:
: WARNING: Overwriting existing file 'DOH-oiii-cube.fits'. [astropy.io.fits.hdu.hdulist]
: WARNING: Overwriting existing file 'DOH-nii-cube.fits'. [astropy.io.fits.hdu.hdulist]
: WARNING: Overwriting existing file 'DOH-ha-cube.fits'. [astropy.io.fits.hdu.hdulist]
...
#+BEGIN_SRC python :tangle makecube.py :results output verbatim
  ...
  hdr.update(CD1_1=-1.45833333333e-4, CRVAL1=83.8164166667, CRPIX1=289.0, CTYPE1="RA---TAN",
             ...
             CD2_2=2.0*km, CRPIX2=1.0, CRVAL2=-314.4*km, CTYPE2="VOPT", CUNIT2="km/s")
...
****** And the same but with RA, Dec offsets from th1C in arcsec
83.8185958334, -5.38977222222

#+BEGIN_SRC python :results output
import numpy as np
import astropy.io.fits as fits
hdu, = fits.open("spm-vstack-oiii.fits")
# coords of th1C
ra0, dec0 = 83.818596, -5.3897722

hdu.header["CRVAL1"] -= ra0
hdu.header["CRVAL1"] *= 3600.0
hdu.header["CTYPE1"] = "LINEAR"
hdu.header["CUNIT1"] = "arcsec"
hdu.header["CD1_1"] *= -3600.0

hdu.header["CRVAL3"] -= dec0
hdu.header["CRVAL3"] *= 3600.0
hdu.header["CTYPE3"] = "LINEAR"
hdu.header["CUNIT3"] = "arcsec"
hdu.header["CD3_3"] *= 3600.0

hdu.header["CTYPE2"] = "LINEAR"

hdu.writeto("spm-vstack-oiii-arcsec.fits", clobber=True)
#+END_SRC

#+RESULTS:
: WARNING: Overwriting existing file 'spm-vstack-oiii-arcsec.fits'. [astropy.io.fits.hdu.hdulist]




#+BEGIN_SRC sh
xpaset -p ds9 fits $PWD/spm-vstack-oiii-arcsec.fits
#+END_SRC
...
pwd
for f in $FILES; do
    rsync -azP $f crya:/http/pub/will/OrionSouth
done
#+END_SRC
...
sent 88 bytes  received 20 bytes  12.71 bytes/sec
total size is 57237  speedup is 529.97
building file list ... 
 0 files...1 file to consider
spm-vstack-oiii.fits
        9472   0%    0.00kB/s    0:00:00    22504320 100%   90.90MB/s    0:00:00 (xfer#1, to-check=0/1)

sent 1582 bytes  received 28554 bytes  6696.89 bytes/sec
total size is 22504320  speedup is 746.76
building file list ... 
 0 files...1 file to consider
spm-vstack-oiii-arcsec.fits
       32768   0%    0.00kB/s    0:00:00     3964928  17%    3.62MB/s    0:00:05     4194304  18%    1.93MB/s    0:00:09     4358144  19%    1.34MB/s    0:00:13     4554752  20% 1009.83kB/s    0:00:17     4784128  21%  170.61kB/s    0:01:43     5046272  22%  164.17kB/s    0:01:46     5308416  23%  175.79kB/s    0:01:37     5537792  24%  181.65kB/s    0:01:33     5767168  25%  176.83kB/s    0:01:34     6029312  26%  177.06kB/s    0:01:33     6291456  27%  175.60kB/s    0:01:32     6553600  29%  167.94kB/s    0:01:34     6750208  29%  167.42kB/s    0:01:34     7012352  31%  165.49kB/s    0:01:33     7274496  32%  168.84kB/s    0:01:30     7503872  33%  176.86kB/s    0:01:24     7733248  34%  182.75kB/s    0:01:20     7929856